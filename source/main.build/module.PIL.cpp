...
static void createModuleCodeObjects(void) {
    ...
    codeobj_cc2acdbc67f92788f061bda7b0fba939 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[36], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    tmp_res = PyDict_DelItem((PyObject *)moduledict_PIL, mod_consts[18]);
    ...
    branch_yes_2:;
    {
        ...
        frame_cc2acdbc67f92788f061bda7b0fba939->m_frame.f_lineno = 75;
    ...
    }
    {
        ...
        tmp_result = HAS_ATTR_BOOL(tmp_expression_value_8, mod_consts[26]);
    ...
    branch_end_2:;
    {
        ...
        tmp_res = PyObject_SetItem(locals_PIL$$$class__1_UnidentifiedImageError_75, mod_consts[31], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(ERROR_OCCURRED());
        ...
        tmp_res = PyObject_SetItem(locals_PIL$$$class__1_UnidentifiedImageError_75, mod_consts[34], tmp_dictset_value);
        if (tmp_res != 0) {
            assert(ERROR_OCCURRED());
        ...
        goto try_except_handler_1;
        outline_result_1:;
        UPDATE_STRING_DICT1(moduledict_PIL, (Nuitka_StringObject *)mod_consts[25], tmp_assign_source_13);
    }
    goto try_end_1;
    // Exception handler code:
