...
static PyCodeObject *codeobj_710ef663de1b859d16a03d97a70d98b9;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[57]); CHECK_OBJECT(module_filename_obj);
    codeobj_0e529250c4a44484e2154e866cd31df2 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[58], NULL, NULL, 0, 0, 0);
    codeobj_b4130476752226af4f1dcff7319b315c = MAKE_CODEOBJECT(module_filename_obj, 23, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[55], mod_consts[59], NULL, 1, 0, 0);
    codeobj_710ef663de1b859d16a03d97a70d98b9 = MAKE_CODEOBJECT(module_filename_obj, 27, CO_OPTIMIZED | CO_NEWLOCALS | CO_NOFREE, mod_consts[56], mod_consts[60], NULL, 0, 0, 0);
}
...
static PyObject *impl_numpy$__config__$$$function__2_show(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    struct Nuitka_FrameObject *frame_710ef663de1b859d16a03d97a70d98b9;
    NUITKA_MAY_BE_UNUSED char const *type_description_1 = NULL;
    PyObject *exception_type = NULL;
    PyObject *exception_value = NULL;
    PyTracebackObject *exception_tb = NULL;
    ...
    static struct Nuitka_FrameObject *cache_frame_710ef663de1b859d16a03d97a70d98b9 = NULL;
    PyObject *tmp_return_value = NULL;
    ...
    // Actual function body.
    // Tried code:
    if (isFrameUnusable(cache_frame_710ef663de1b859d16a03d97a70d98b9)) {
        Py_XDECREF(cache_frame_710ef663de1b859d16a03d97a70d98b9);

#if _DEBUG_REFCOUNTS
        if (cache_frame_710ef663de1b859d16a03d97a70d98b9 == NULL) {
            count_active_frame_cache_instances += 1;
        } else {
            count_released_frame_cache_instances += 1;
        }
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_710ef663de1b859d16a03d97a70d98b9 = MAKE_FUNCTION_FRAME(codeobj_710ef663de1b859d16a03d97a70d98b9, module_numpy$__config__, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    }
    assert(cache_frame_710ef663de1b859d16a03d97a70d98b9->m_type_description == NULL);
    frame_710ef663de1b859d16a03d97a70d98b9 = cache_frame_710ef663de1b859d16a03d97a70d98b9;

    // Push the new frame as the currently active one.
    pushFrameStack(frame_710ef663de1b859d16a03d97a70d98b9);

    // Mark the frame object as in use, ref count 1 will be up for reuse.
    assert(Py_REFCNT(frame_710ef663de1b859d16a03d97a70d98b9) == 2); // Frame stack
    ...
    // Framed code:
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 94;
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 97;
    ...
    branch_no_1:;
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 99;
    ...
    branch_yes_2:;
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 101;
    ...
    branch_no_2:;
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 102;
    ...
    branch_no_3:;
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 106;
    ...
    branch_yes_4:;
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 111;
    ...
    branch_no_4:;
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 113;
    ...
    tmp_for_loop_3__for_iterator = NULL;
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 115;
    ...
    }
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 116;
    ...
    }
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 117;
    ...
    }
    {
        ...
        frame_710ef663de1b859d16a03d97a70d98b9->m_frame.f_lineno = 118;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_710ef663de1b859d16a03d97a70d98b9);
#endif
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_710ef663de1b859d16a03d97a70d98b9, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_710ef663de1b859d16a03d97a70d98b9->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_710ef663de1b859d16a03d97a70d98b9, exception_lineno);
    }

    // Attaches locals to frame if any.
    Nuitka_Frame_AttachLocals(
        frame_710ef663de1b859d16a03d97a70d98b9,
        type_description_1,
    ...
    // Release cached frame if used for exception.
    if (frame_710ef663de1b859d16a03d97a70d98b9 == cache_frame_710ef663de1b859d16a03d97a70d98b9) {
#if _DEBUG_REFCOUNTS
        count_active_frame_cache_instances -= 1;
        count_released_frame_cache_instances += 1;
#endif

        Py_DECREF(cache_frame_710ef663de1b859d16a03d97a70d98b9);
        cache_frame_710ef663de1b859d16a03d97a70d98b9 = NULL;
    }

    assertFrameObject(frame_710ef663de1b859d16a03d97a70d98b9);
...
static PyObject *MAKE_FUNCTION_numpy$__config__$$$function__2_show() {
    struct Nuitka_FunctionObject *result = Nuitka_Function_New(
        ...
        NULL,
#endif
        codeobj_710ef663de1b859d16a03d97a70d98b9,
        NULL,
#if PYTHON_VERSION >= 0x300
        NULL,
        NULL,
